    ...
    <div className="min-h-dvh bg-[#f8fafc] dark:bg-slate-950 pb-24 text-slate-900 dark:text-slate-100 transition-colors duration-300">
      <div className="mx-auto max-w-md px-4 pt-4 space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              {profile && (
                <button
                  ...
                  title="Sign Out"
                  className="bg-slate-800/60 text-rose-400 p-2.5 rounded-full hover:bg-rose-500 hover:text-white transition-all border border-slate-700/50"
                >
        ...
        {activeTab === "orders" && (
          <div className="space-y-4 animate-morph-in">
            ...
            <div className="bg-gradient-to-r from-amber-500/5 to-orange-500/5 border border-amber-500/10 p-5 rounded-[28px] shadow-sm">
              <div className="flex items-start gap-3">
                <div className="h-10 w-10 rounded-xl bg-orange-50 dark:bg-orange-950/30 flex items-center justify-center text-orange-500 border border-orange-100 dark:border-orange-900/50">
                  <Wallet className="h-4.5 w-4.5" />
                </div>
                <div className="space-y-1 flex-1">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-extrabold text-slate-700 dark:text-slate-300">Mtopup Balance</span>
                    <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                  </div>
                  <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400">WALLET BALANCE</p>
                  <div className="flex items-baseline gap-1.5 pt-1">
                    <span className="text-2xl font-black tracking-tight text-slate-800 dark:text-slate-100">
                      GHS 0.00
                    </span>
                    <span className="text-[10px] font-bold text-slate-400">GHANA CEDI</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="grid grid-cols-4 gap-3">
                {[
                  { id: "order", label: "Order", icon: ShoppingBag, color: "rose" },
                  { id: "reward", label: "Reward", icon: Gift, color: "emerald" },
                  { id: "data", label: "Data", icon: Database, color: "violet" },
                  { id: "deposit", label: "Deposit", icon: Wallet, color: "blue" },
                  { id: "trans", label: "Trans", icon: Receipt, color: "rose" },
                  { id: "vendor", label: "Vendor", icon: Store, color: "violet" },
                  ...
                  const colClasses: Record<string, string> = {
                    rose: "bg-rose-50 dark:bg-rose-950/40 text-rose-500 border-rose-100 dark:border-rose-900/50",
                    emerald: "bg-emerald-50 dark:bg-emerald-950/40 text-emerald-500 border-emerald-100 dark:border-emerald-900/50",
                    violet: "bg-violet-50 dark:bg-violet-950/40 text-violet-500 border-violet-100 dark:border-violet-900/50",
                  ...
                  return (
                    <button
                      ...
                      className="flex flex-col items-center justify-center p-3 rounded-[24px] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 shadow-sm transition-all duration-300 hover:translate-y-[-2px] hover:shadow-md"
                    >
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/60 p-6 rounded-[32px] shadow-sm space-y-5">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-full bg-[#0d1527] flex items-center justify-center border border-blue-900 text-amber-400 shadow-inner">
                  <span className="font-extrabold text-sm tracking-tighter">II</span>
                </div>
                <div className="flex items-baseline">
                  <span className="text-xl font-black text-slate-800 dark:text-white">Mto</span>
                  <span className="text-xl font-black text-rose-500">pup</span>
                </div>
              </div>
              ...
              <div className="space-y-3.5 pt-2 border-t border-slate-100 dark:border-slate-800">
                <p className="text-[10px] font-extrabold text-rose-500 uppercase tracking-widest">CONTACT US</p>
                ...
                {[
                  ...
                  return (
                    <Comp
                      ...
                      className={`flex items-center gap-3 p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800/60 text-xs font-semibold text-slate-700 dark:text-slate-300 transition-colors ${
                        item.href ? "hover:bg-slate-100 dark:hover:bg-slate-800" : ""
                      }`}
                    >
      ...
      {agent.support_whatsapp && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="fixed bottom-24 right-5 z-40 bg-emerald-500 hover:bg-emerald-600 text-white p-3.5 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group flex items-center justify-center animate-bounce duration-1000"
          style={{ animationDuration: '3s' }}
        >
          <MessageCircle className="h-5.5 w-5.5 group-hover:scale-110 transition-transform" />
          <span className="absolute -top-1.5 -right-1.5 bg-red-500 text-white font-extrabold text-[9px] h-5 w-5 rounded-full border-2 border-white dark:border-slate-950 flex items-center justify-center animate-pulse">
            !
          </span>
        </a>
      )}
      ...
      {(agent.support_phone || agent.support_whatsapp) && (
        <a
          ...
          className="fixed bottom-6 right-5 z-40 bg-gradient-to-br from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-700 text-white p-3.5 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group flex items-center justify-center"
        >
          <Headphones className="h-5.5 w-5.5 group-hover:rotate-12 transition-transform" />
          <span className="absolute -top-1.5 -right-1.5 bg-red-500 text-white font-extrabold text-[9px] h-5 w-5 rounded-full border-2 border-white dark:border-slate-950 flex items-center justify-center">
            ?
          </span>
        </a>
      )}
